...
} else if (command == 'play3' || command == 'play4') {
...
let cap = `╭━❰  ${wm}  ❱━⬣\n┃⭐ 𝗖𝗶𝘀𝗰𝗼 𝗕𝗼𝘁 𝗧𝘂𝗿𝗯𝗼 ⭐\n┃ও *${mid.smsYT1}:* \n┃» ${ttl}\n┃﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘\n┃ও *${mid.smsYT11}:*\n┃» ${size}\n╰━━━━━❰ *𓃠 ${vs}* ❱━━━━⬣`.trim()
await conn.sendMessage(m.chat, { audio: { url: dl_url }, caption: cap, mimetype: 'audio/mpeg', contextInfo: {
externalAdReply: {
title: ttl,
body: "",
...
await conn.sendMessage(m.chat, {audio: { url: lolh.result.link }, caption: `╭━❰  ${wm}  ❱━⬣\n┃⭐ 𝗖𝗶𝘀𝗰𝗼 𝗕𝗼𝘁 𝗧𝘂𝗿𝗯𝗼 ⭐\n┃ও *${mid.smsYT1}:* \n┃» ${n}\n╰━━━━━❰ *𓃠 ${vs}* ❱━━━━⬣`, fileName: `${n}.mp3`, mimetype: 'audio/mpeg', contextInfo: {
externalAdReply: {
title: n, 
body: "",
thumbnailUrl: yt_play[0].thumbnail, 
...
await conn.sendMessage(m.chat, { audio: { url: ress.url }, fileName: __res[0].title + '.mp3', mimetype: 'audio/mpeg', contextInfo: {
externalAdReply: {
title: __res[0].title,
body: "",
thumbnailUrl: yt_play[0].thumbnail, 
...
await conn.sendMessage(m.chat, { video: { url: dl_url }, caption: `╭━❰  ${wm}  ❱━⬣\n┃⭐ 𝗖𝗶𝘀𝗰𝗼 𝗕𝗼𝘁 𝗧𝘂𝗿𝗯𝗼 ⭐\n┃ও *${mid.smsYT1}:* \n┃» ${ttl}\n┃﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘\n┃ও *${mid.smsYT11}:*\n┃» ${size}\n╰━━━━━❰ *𓃠 ${vs}* ❱━━━━⬣`, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', contextInfo: {
externalAdReply: {
title: ttl,
body: "",
thumbnailUrl: yt_play[0].thumbnail, 
...
handler.command = /^(play|play2|play3|play4)$/i;
//handler.limit = 3
